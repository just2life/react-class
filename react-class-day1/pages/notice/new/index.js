...
const CREATE_NOTICE = gql`
  mutation noticeCRUD(
    $writerVariable: String
    $passwordVariable: String
    $titleVariable: String
    $contentsVariable: String
  ) {
    createNotice(
      writerBack: $writerVariable
      passwordBack: $passwordVariable
      titleBack: $titleVariable
      contentsBack: $contentsVariable
    ) {
      id
      message
    }
